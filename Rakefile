...
x86Builder = XcodeBuilder::XcodeBuilder.new do |config|
  ...
  config.workspace_file_path = "MediaManagement.xcworkspace"
...
armBuilder = XcodeBuilder::XcodeBuilder.new do |config|
  ...
  config.build_dir = :derived
  config.workspace_file_path = "MediaManagement.xcworkspace"
  config.scheme = "MediaManagementARM"
  config.configuration = "Release" 
  config.sdk = "iphoneos"
  ...
  config.tag_vcs = true
  config.pod_repo = "kra"
  config.podspec_file = "MediaManagement.podspec"
...
task :clean do
	...
	FileUtils.rm_rf armBuilder.configuration.workspace_file_path
